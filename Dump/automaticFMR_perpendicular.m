...
filen = '02_FeO_sampleG_Bout_RT.txt';
data = load(filen);
...
rangeX2 = 3; % Multiplier on Lorentizan fits
...
%     ini = 0;
    ...
    lower = [-10 -10 -1 -1 -50 0.001];
    upper = [ 10  10 1  1 10 10];
...
gyro = fit1.a; muMs = fit1.c; Gyro = fit1.a;
% Errors
[intervals] = confint(fit1);
deltac = abs(abs(intervals(1,2))-abs(intervals(2,2)));
